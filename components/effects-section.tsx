            ...
            <div className="flex-1 p-8 md:p-10">
              ...
              <div className="flex items-center justify-center gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-5xl font-bold text-gray-700 md:text-6xl">100</div>
                ...
                <div className="flex flex-col items-center">
                  <div className="rounded-full bg-[#FF6B35] px-4 py-2 text-sm font-bold text-white">44万円削減</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-5xl font-bold text-[#FF6B35] md:text-6xl">56</div>
              ...
              <div className="mt-8 rounded-lg bg-gradient-to-r from-orange-50 to-orange-100 p-4 text-center">
                ...
                <div className="mt-1 text-3xl font-bold text-[#FF6B35] md:text-4xl">528万円</div>
              </div>
            </div>
            ...
            <div className="flex-1 p-8 md:p-10">
              ...
              <div className="flex items-center justify-center gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-5xl font-bold text-gray-700 md:text-6xl">25</div>
                ...
                <div className="flex flex-col items-center">
                  <div className="rounded-full bg-[#FF6B35] px-4 py-2 text-sm font-bold text-white">60%改善</div>
                  <svg className="mt-2 h-8 w-8 text-[#FF6B35]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                  </svg>
                </div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-5xl font-bold text-[#FF6B35] md:text-6xl">10</div>
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                <div className="rounded-lg bg-gray-50 p-4 text-center">
                  <div className="text-xs font-medium text-muted-foreground">従来の確認時間</div>
                  <div className="mt-2 text-2xl font-bold text-gray-700">2-3日</div>
                </div>
                <div className="rounded-lg bg-gradient-to-br from-orange-50 to-orange-100 p-4 text-center">
                  <div className="text-xs font-medium text-muted-foreground">PLUS TALENTの確認時間</div>
                  <div className="mt-2 text-2xl font-bold text-[#FF6B35]">リアルタイム</div>
                </div>
              </div>
            </div>
