...
export function HeroSection() {
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden bg-white">
      ...
      <div className="container mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          {/* Left column - Text content */}
          <div className="space-y-6">
            <h1 className="font-sans text-3xl font-bold leading-tight tracking-tight text-primary text-balance md:text-4xl lg:text-4xl">
              新興国の優秀な人材を<br />
              <span className="text-accent">"雇用代行"</span>で採用しませんか？
            </h1>
